...
const realtime_controller_js_1 = require("./realtime.controller.js");
...
exports.RealtimeModule = RealtimeModule = __decorate([
    (0, common_1.Global)(),
    (0, common_1.Module)({
        controllers: [realtime_controller_js_1.RealtimeController],
        providers: [realtime_service_js_1.RealtimeService],
        exports: [realtime_service_js_1.RealtimeService],
    })
], RealtimeModule);
