...
export declare class WhatsAppMessagesService {
    ...
    constructor(prisma: PrismaService, graph: WhatsAppGraphService, accounts: WhatsAppAccountService, ai: AiService, storage: ObjectStorageService, realtime: RealtimeService);
