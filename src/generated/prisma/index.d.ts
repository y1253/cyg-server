...
export namespace Prisma {
  ...
  */
   ...
   * ClientCountOutputType without action
   */
  export type ClientCountOutputTypeCountAssignmentsArgs<
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
  > = {
    where?: AssignmentWhereInput;
  };
  ...
  > extends Prisma.PrismaPromise<T> {
    readonly [Symbol.toStringTag]: 'PrismaPromise';
    assignments<T extends Client$assignmentsArgs<ExtArgs> = {}>(
      args?: Subset<T, Client$assignmentsArgs<ExtArgs>>,
    ): Prisma.PrismaPromise<
      | $Result.GetResult<
          Prisma.$AssignmentPayload<ExtArgs>,
          T,
      ...
      | Null
    >;
    tasks<T extends Client$tasksArgs<ExtArgs> = {}>(
      args?: Subset<T, Client$tasksArgs<ExtArgs>>,
    ): Prisma.PrismaPromise<
      | $Result.GetResult<
          Prisma.$TaskPayload<ExtArgs>,
          T,
   ...
   * Client.assignments
   */
  export type Client$assignmentsArgs<
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
  > = {
    /**
     * Select specific fields to fetch from the Assignment
  ...
  export type AssignmentWhereUniqueInput = Prisma.AtLeast<
    {
      id?: number;
      userId_clientId?: AssignmentUserIdClientIdCompoundUniqueInput;
      AND?: AssignmentWhereInput | AssignmentWhereInput[];
      OR?: AssignmentWhereInput[];
      NOT?: AssignmentWhereInput | AssignmentWhereInput[];
      userId?: IntFilter<'Assignment'> | number;
  ...
  export type AssignmentCreateNestedManyWithoutUserInput = {
    create?:
      | XOR<
          AssignmentCreateWithoutUserInput,
          AssignmentUncheckedCreateWithoutUserInput
        >
      | AssignmentCreateWithoutUserInput[]
      | AssignmentUncheckedCreateWithoutUserInput[];
    connectOrCreate?:
      | AssignmentCreateOrConnectWithoutUserInput
      | AssignmentCreateOrConnectWithoutUserInput[];
  ...
  export type AssignmentUpdateManyWithoutUserNestedInput = {
    ...
    connectOrCreate?:
      ...
      | AssignmentCreateOrConnectWithoutUserInput[];
    upsert?:
      | AssignmentUpsertWithWhereUniqueWithoutUserInput
      | AssignmentUpsertWithWhereUniqueWithoutUserInput[];
    createMany?: AssignmentCreateManyUserInputEnvelope;
    ...
    connect?: AssignmentWhereUniqueInput | AssignmentWhereUniqueInput[];
    update?:
      | AssignmentUpdateWithWhereUniqueWithoutUserInput
      | AssignmentUpdateWithWhereUniqueWithoutUserInput[];
    updateMany?:
      | AssignmentUpdateManyWithWhereWithoutUserInput
      | AssignmentUpdateManyWithWhereWithoutUserInput[];
  ...
  export type AssignmentCreateNestedManyWithoutClientInput = {
    create?:
      | XOR<
          AssignmentCreateWithoutClientInput,
          AssignmentUncheckedCreateWithoutClientInput
        >
      | AssignmentCreateWithoutClientInput[]
      | AssignmentUncheckedCreateWithoutClientInput[];
    connectOrCreate?:
      | AssignmentCreateOrConnectWithoutClientInput
      | AssignmentCreateOrConnectWithoutClientInput[];
  ...
  export type TaskCreateNestedManyWithoutClientInput = {
    create?:
      | XOR<TaskCreateWithoutClientInput, TaskUncheckedCreateWithoutClientInput>
      | TaskCreateWithoutClientInput[]
      | TaskUncheckedCreateWithoutClientInput[];
    connectOrCreate?:
      | TaskCreateOrConnectWithoutClientInput
      | TaskCreateOrConnectWithoutClientInput[];
  ...
  export type AssignmentUpdateManyWithoutClientNestedInput = {
    ...
    connectOrCreate?:
      ...
      | AssignmentCreateOrConnectWithoutClientInput[];
    upsert?:
      | AssignmentUpsertWithWhereUniqueWithoutClientInput
      | AssignmentUpsertWithWhereUniqueWithoutClientInput[];
    createMany?: AssignmentCreateManyClientInputEnvelope;
    set?: AssignmentWhereUniqueInput | AssignmentWhereUniqueInput[];
    disconnect?: AssignmentWhereUniqueInput | AssignmentWhereUniqueInput[];
    ...
    connect?: AssignmentWhereUniqueInput | AssignmentWhereUniqueInput[];
    update?:
      | AssignmentUpdateWithWhereUniqueWithoutClientInput
      | AssignmentUpdateWithWhereUniqueWithoutClientInput[];
    updateMany?:
      | AssignmentUpdateManyWithWhereWithoutClientInput
      | AssignmentUpdateManyWithWhereWithoutClientInput[];
    deleteMany?: AssignmentScalarWhereInput | AssignmentScalarWhereInput[];
  };
  ...
  export type TaskUpdateManyWithoutClientNestedInput = {
    ...
    connectOrCreate?:
      ...
      | TaskCreateOrConnectWithoutClientInput[];
    upsert?:
      | TaskUpsertWithWhereUniqueWithoutClientInput
      | TaskUpsertWithWhereUniqueWithoutClientInput[];
    createMany?: TaskCreateManyClientInputEnvelope;
    set?: TaskWhereUniqueInput | TaskWhereUniqueInput[];
    disconnect?: TaskWhereUniqueInput | TaskWhereUniqueInput[];
    ...
    connect?: TaskWhereUniqueInput | TaskWhereUniqueInput[];
    update?:
      | TaskUpdateWithWhereUniqueWithoutClientInput
      | TaskUpdateWithWhereUniqueWithoutClientInput[];
    updateMany?:
      | TaskUpdateManyWithWhereWithoutClientInput
      | TaskUpdateManyWithWhereWithoutClientInput[];
    deleteMany?: TaskScalarWhereInput | TaskScalarWhereInput[];
  };
  ...
  export type ClientCreateNestedOneWithoutAssignmentsInput = {
    create?: XOR<
      ClientCreateWithoutAssignmentsInput,
      ClientUncheckedCreateWithoutAssignmentsInput
    >;
  ...
  export type ClientUpdateOneRequiredWithoutAssignmentsNestedInput = {
    ...
    update?: XOR<
      XOR<
        ClientUpdateToOneWithWhereWithoutAssignmentsInput,
        ClientUpdateWithoutAssignmentsInput
      >,
      ClientUncheckedUpdateWithoutAssignmentsInput
    >;
  };
  ...
  export type ClientUpdateOneRequiredWithoutTasksNestedInput = {
    ...
    update?: XOR<
      XOR<
        ClientUpdateToOneWithWhereWithoutTasksInput,
  ...
  export type AssignmentUpsertWithWhereUniqueWithoutUserInput = {
    where: AssignmentWhereUniqueInput;
    update: XOR<
      AssignmentUpdateWithoutUserInput,
      AssignmentUncheckedUpdateWithoutUserInput
    >;
    create: XOR<
      AssignmentCreateWithoutUserInput,
      AssignmentUncheckedCreateWithoutUserInput
  ...
  export type AssignmentUpdateManyWithWhereWithoutUserInput = {
    ...
    data: XOR<
      AssignmentUpdateManyMutationInput,
      AssignmentUncheckedUpdateManyWithoutUserInput
    >;
  };
  ...
  export type AssignmentUpsertWithWhereUniqueWithoutClientInput = {
    where: AssignmentWhereUniqueInput;
    update: XOR<
      AssignmentUpdateWithoutClientInput,
      AssignmentUncheckedUpdateWithoutClientInput
    >;
    create: XOR<
      AssignmentCreateWithoutClientInput,
      AssignmentUncheckedCreateWithoutClientInput
  ...
  export type AssignmentUpdateManyWithWhereWithoutClientInput = {
    ...
    data: XOR<
      AssignmentUpdateManyMutationInput,
      AssignmentUncheckedUpdateManyWithoutClientInput
    >;
  };
  ...
  export type TaskUpdateManyWithWhereWithoutClientInput = {
    ...
    data: XOR<
      TaskUpdateManyMutationInput,
      TaskUncheckedUpdateManyWithoutClientInput
    >;
  };
